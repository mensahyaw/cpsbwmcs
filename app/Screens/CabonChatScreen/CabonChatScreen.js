...
<View style={styles.cpss}>
          ...
          <Text style={styles.Thome}>Mensah Emision Device</Text>
          <LineChart
            data={data}
            width={screenWidth}
            height={250}
          ...
          />
          <Text style={styles.Thome}>BBS Emision Device</Text>
          <LineChart
            data={data2}
            width={screenWidth}
            height={250}
...
<Text style={styles.Thome}>EAH Emision Device</Text>
          <LineChart
            data={data3}
            width={screenWidth}
            height={250}
...
<Text style={styles.Thome}>BUTH Emision Device</Text>
          <LineChart
            data={data4}
            width={screenWidth}
            height={250}
...
<Text style={styles.Thome}>SAT Emision Device</Text>
          <LineChart
            data={data5}
            width={screenWidth}
            height={250}
