  ...
  <View style={styles.containerb}>
    ...
    ref={inputRef} 
      ...
      style={[
        ...
        {fontWeight: '900', textAlign:'center', paddingBottom:'40%'},
      ]}
     
    />
     <Text style={styles.TitleAbout}>RPM CO<Text style={styles.subscript}>2</Text></Text>
     <Text style={styles.Titlehome}>Detected from Mensah Emission Device</Text>
     <Image source={Co2}  resizeMode='contain'/>
...
export default MainCabonScreen